...
const fs = require("fs");
function asyncFsReaddir(dir, num) {
...
function middleware(ctx, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const files = yield asyncFsReaddir('.', counter);
        ctx.data.push('hi from ' + counter);
        yield next(); // next is the next middleware in the stack, and must return a promise! async functions does this implicity, but normal functions does not, this is why you must remember to return a promise in your "normal" middleware functions.
        console.log('Ended middleware ' + counter);
        counter--;
    });
}
function syncMiddleware(ctx, next) {
...
function middlewareWithoutNext(ctx, next) {
    return __awaiter(this, void 0, void 0, function* () {
...
mf(ctx, (ctx, next) => __awaiter(this, void 0, void 0, function* () {
...
*/
//# sourceMappingURL=async-eventloop.js.map